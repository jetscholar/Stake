...
class Blockchain():
    ...
    def getCoveredTranasctionSet(self, transactions):
        coveredTransactions = []
    ...
    def createBlock(self, transactionFromPool, forgerWallet):
        coveredTransactions = self.getCoveredTranasctionSet(transactionFromPool)
    ...
    def transactionValid(self, transactions):
        coveredTransactions = self.getCoveredTranasctionSet(transactions)
